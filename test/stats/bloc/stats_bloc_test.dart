...
import 'package:todos/stats/bloc/stats_bloc.dart';
import 'package:todos_repository/todos_repository.dart';

class MockTodosRepository extends Mock implements TodosRepository {}

void main() {
  final todo = Todo(id: '1', title: 'title 1', description: 'description 1');
      ...
      blocTest<StatsBloc, StatsState>(
        ...
        expect:
            () => [
              ...
              const StatsState(status: StatsStatus.success, activeTodos: 1),
            ],
      );
