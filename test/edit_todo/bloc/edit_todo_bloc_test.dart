...
import 'package:todos/editTodo/bloc/edit_todo_bloc.dart';
...
void main() {
  group('EditTodoBloc', () {
    ...
    EditTodoBloc buildBloc() {
      return EditTodoBloc(todosRepository: todosRepository, initialTodo: null);
    }
    ...
    group('constructor', () {
      ...
      test('has correct initial state', () {
        expect(buildBloc().state, equals(const EditTodoState()));
      });
    });
    ...
    group('EditTodoTitleChanged', () {
      blocTest<EditTodoBloc, EditTodoState>(
        ...
        expect: () => const [EditTodoState(title: 'newtitle')],
      );
    });
    ...
    group('EditTodoDescriptionChanged', () {
      blocTest<EditTodoBloc, EditTodoState>(
        ...
        expect: () => const [EditTodoState(description: 'newdescription')],
      );
    });
    ...
    group('EditTodoSubmitted', () {
      blocTest<EditTodoBloc, EditTodoState>(
        ...
        seed:
            () =>
                const EditTodoState(title: 'title', description: 'description'),
      ...
      blocTest<EditTodoBloc, EditTodoState>(
        ...
        seed:
            () => EditTodoState(
              initialTodo: Todo(id: 'initial-id', title: 'initial-title'),
              title: 'title',
              description: 'description',
            ),
        act: (bloc) => bloc.add(const EditTodoSubmitted()),
