...
void main() {
  ...
  group('HomePage', () {
    ...
    testWidgets('renders HomeView', (tester) async {
      await tester.pumpApp(const HomePage(), todosRepository: todosRepository);
  ...
  group('HomeView', () {
    ...
    Widget buildSubject() {
      return MockNavigatorProvider(
        navigator: navigator,
        child: BlocProvider.value(value: cubit, child: const HomeView()),
      );
    }

    testWidgets('renders TodosOverviewPage '
        'when tab is set to HomeTab.todos', (tester) async {
      when(() => cubit.state).thenReturn(const HomeState());
    ...
    testWidgets('renders StatsPage '
        'when tab is set to HomeTab.stats', (tester) async {
    ...
    testWidgets('calls setTab with HomeTab.todos on HomeCubit '
    ...
    testWidgets('calls setTab with HomeTab.stats on HomeCubit '
    ...
    group('add todo floating action button', () {
      testWidgets('is rendered', (tester) async {
        ...
        expect(find.byKey(addTodoFloatingActionButtonKey), findsOneWidget);

        final addTodoFloatingActionButton = tester.widget(
          find.byKey(addTodoFloatingActionButtonKey),
        );
        expect(addTodoFloatingActionButton, isA<FloatingActionButton>());
      });
      ...
      testWidgets('navigates to the EditTodoPage when pressed', (tester) async {
        await tester.pumpApp(buildSubject(), todosRepository: todosRepository);
